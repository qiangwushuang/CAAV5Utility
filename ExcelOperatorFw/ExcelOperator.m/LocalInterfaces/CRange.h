...
public:
	...
	VARIANT Delete(VARIANT IndexRC)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x75, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &IndexRC);
		return result;
	}
	...
	VARIANT Insert(VARIANT IndexRC)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xfc, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &IndexRC);
		return result;
	}
