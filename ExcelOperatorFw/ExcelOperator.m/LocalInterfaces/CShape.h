...
public:
	...
	{
		long result;
		InvokeHelper(0xb66, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_SmartArt()
	{
		LPDISPATCH result;
		InvokeHelper(0xb67, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	CString get_Title()
	{
	...
	{
		long result;
		InvokeHelper(0xcc8, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_GraphicStyle(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xcc8, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	LPDISPATCH get_Model3D()
	{
		LPDISPATCH result;
		InvokeHelper(0xd1d, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	long get_Decorative()
	{
	...
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xd1e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
